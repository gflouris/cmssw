...
process.source = cms.Source('PoolSource',
 #fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/g/gflouris/public/SingleMuPt1_20_eta.root')
...
#process.simTwinMuxDigisEmu.DTDigi_Source = cms.InputTag("simDtTriggerPrimitiveDigis")
#process.simTwinMuxDigisEmu.DTThetaDigi_Source = cms.InputTag("simDtTriggerPrimitiveDigis")
...
process.out = cms.OutputModule("PoolOutputModule", 
   ...
   fileName = cms.untracked.string("l1twinmux_test_mu_antimu_atan.root")
)

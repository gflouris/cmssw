...
L1TMuon::MBLTCollection::MBLTCollection( const DTChamberId & dtId )
{
  _wheel = dtId.wheel();
  _sector = dtId.sector();
...
void L1TMuon::MBLTCollection::addStub(const TriggerPrimitiveRef& stub)
{
...
void L1TMuon::MBLTCollection::associate( double minRpcPhi )
{
...
L1TMuon::TriggerPrimitiveList L1TMuon::MBLTCollection::getRpcInAssociatedStubs( size_t dtIndex ) const
{

  L1TMuon::TriggerPrimitiveList returnList;
...
L1TMuon::TriggerPrimitiveList L1TMuon::MBLTCollection::getRpcOutAssociatedStubs( size_t dtIndex ) const
{
...
L1TMuon::TriggerPrimitiveList
L1TMuon::MBLTCollection::getRpcInUnassociatedStubs() const
{
...
L1TMuon::TriggerPrimitiveList
L1TMuon::MBLTCollection::getRpcOutUnassociatedStubs() const
{
...
L1TMuon::MBLTCollection::bxMatch L1TMuon::MBLTCollection::haveCommonRpc( size_t dt1, size_t dt2 ) const
{

  L1TMuon::MBLTCollection::bxMatch ret_val = NOMATCH;
...
/////////// RPC UTIL
bool
L1TMuon::MBLTCollection::areCloseClusters( std::vector< size_t > & cluster1,
					  std::vector< size_t > & cluster2,
					  const L1TMuon::TriggerPrimitiveList & rpcList1,
					  const L1TMuon::TriggerPrimitiveList & rpcList2,
...
/////////// RPC UTILS
size_t
L1TMuon::MBLTCollection::reduceRpcClusters( std::vector< std::vector <size_t> > & clusters,
					   const L1TMuon::TriggerPrimitiveList & rpcList,
					   double minRpcPhi ) const
{
...
/////////// RPC UTIL
void
L1TMuon::MBLTCollection::getUnassociatedRpcClusters( const std::vector< size_t > & rpcUnass,
						    const L1TMuon::TriggerPrimitiveList & rpcList,
						    double minRpcPhi,
...
/////////// RPC UTIL
std::vector< std::pair< L1TMuon::TriggerPrimitiveList, L1TMuon::TriggerPrimitiveList > >
L1TMuon::MBLTCollection::getUnassociatedRpcClusters( double minRpcPhi ) const
{

  using L1TMuon::TriggerPrimitiveList;
